...
const galleryData: readonly GalleryItem[] = [
  {
    id: "gal-1",
    category: "okolicznosciowe",
    title: "Bukiet Pastelowy Premium",
    url: "https://images.unsplash.com/photo-1561181286-d3fee7d55364?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  },
  {
    id: "gal-2",
    category: "slubne",
    title: "Klasyczny Bukiet Ślubny",
    url: "https://images.unsplash.com/photo-1526047932273-341f2a7631f9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  },
  {
    id: "gal-3",
    category: "dekoracje",
    title: "Kompozycja Stołowa Eucalyptus",
    url: "https://flowering.pl/wp-content/uploads/2024/10/klasyczna-kompozycja-z-bialych-lilii-i-roz.png",
  },
  {
    id: "gal-4",
    category: "okolicznosciowe",
    title: "Romantyczne Czerwone Róże",
    url: "https://images.unsplash.com/photo-1582794543139-8ac9cb0f7b11?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  },
  {
    id: "gal-5",
    category: "slubne",
    title: "Aranżacja Kościoła Boho",
    url: "https://tse2.mm.bing.net/th/id/OIP.UEH1dPJ8UyPXmDdiRws7RwHaHa?r=0&rs=1&pid=ImgDetMain&o=7&rm=3",
  },
  {
    id: "gal-6",
    category: "dekoracje",
    title: "Zielone Detale dla Biura",
    url: "https://helloflowers.pl/wp-content/uploads/2023/08/bukiet_80bialychroz.jpg",
  },
];
...
const offerData: readonly OfferItem[] = [
  {
    ...
    desc: "Na urodziny, rocznice i ważne momenty. Świeże kwiaty idealnie dopasowane do okazji.",
  },
  {
    icon: <Heart className="w-8 h-8" />,
    title: "Florystyka ślubna",
    desc: "Bukiety ślubne, dekoracje sal i aut. Tworzymy niezapomnianą oprawę Waszego dnia.",
  },
  {
    icon: <Camera className="w-8 h-8" />,
    title: "Wystrój wnętrz",
    desc: "Kompozycje do biur, restauracji i hoteli. Zielone detale, które ożywią każdą przestrzeń.",
  },
];
    ...
    <section className="relative pt-40 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden">
      ...
      >
        <div className="w-full md:w-1/2 z-10">
          ...
          >
            Wyjątkowe bukiety i kompozycje kwiatowe w sercu Radzynia
            Podlaskiego. Tworzymy z pasją dla Twoich najważniejszych chwil.
          </motion.p>
          <div className="flex gap-4">
            <a
              href="tel:512316377"
              className="flex items-center justify-center gap-2 px-8 py-4 bg-rose-500 hover:bg-rose-600 text-white rounded-full font-medium text-lg shadow-lg shadow-rose-500/20 transition-all active:scale-95 w-full sm:w-auto"
            >
  ...
  return (
    <div className={isDark ? "dark" : ""}>
      ...
      >
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              ...
              <h2 className="text-4xl font-bold mb-6">
                Stworzone z miłości do piękna
              </h2>
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
                Kwiaciarnia MEJ Ewa Jawoszek to miejsce, w którym tradycja
                spotyka się z nowoczesnym podejściem do florystyki. Dbamy o to,
                aby każdy kwiat był świeży, a każda kompozycja unikalna.
                Niezależnie od tego, czy szukasz drobnego upominku, czy
                majestatycznej oprawy uroczystości – jesteśmy tu, by doradzić i
        ...
        <section
          id="galeria"
          className="py-24 bg-white/50 dark:bg-slate-900/50"
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-2xl mx-auto mb-12">
              <h2 className="text-4xl font-bold mb-4">
                Galeria naszych kompozycji
              </h2>
              <p className="text-slate-600 dark:text-slate-400">
                Inspiracje stworzone w naszej pracowni. Kliknij zdjęcie, aby je
                powiększyć.
              </p>
            </div>
        ...
        <section
          id="kontakt-mej"
          className="py-24 bg-rose-50/50 dark:bg-slate-900/50"
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="bg-white dark:bg-slate-950 rounded-[3rem] shadow-2xl shadow-rose-100/50 dark:shadow-none border border-rose-100 dark:border-slate-800 overflow-hidden flex flex-col lg:flex-row">
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="tel:123123123"
                        className="text-rose-500 hover:text-rose-600 font-bold text-lg transition-colors"
                      >
                        123 123 123
                      </a>
                    </div>
              ...
              <div className="w-full lg:w-1/2 bg-slate-100 dark:bg-slate-900 relative min-h-[400px] overflow-hidden rounded-2xl">
                {/* Mapa Google Maps wklejona jako iframe */}
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2449.613346517173!2d22.61658427712399!3d51.782327019448835!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47221930c749c665%3A0x4565d6fe94b05936!2sWarszawska%205%2C%2021-300%20Radzy%C5%84%20Podlaski!5e0!3m2!1spl!2spl!4v1716760000000!5m2!1spl!2spl"
                ...
                {/* Delikatny gradient nakładany na mapę (opcjonalnie, usuń jeśli mapa jest zbyt ciemna/jasna) */}
                <div className="absolute inset-0 bg-gradient-to-r from-white via-transparent to-transparent dark:from-slate-950 opacity-40 pointer-events-none" />

                {/* Widżet z adresem w prawym dolnym rogu */}
                <div className="absolute bottom-8 right-8 bg-white dark:bg-slate-800 px-6 py-4 rounded-2xl shadow-xl flex items-center gap-3 border border-slate-100 dark:border-slate-700 z-10">
                  <MapPin className="w-6 h-6 text-rose-500" />
                  <span className="font-medium text-slate-900 dark:text-white">
                    Warszawska 5, Radzyń Podlaski
                  </span>
                </div>
              </div>
            </div>
        ...
        <footer className="py-8 text-center text-slate-500 dark:text-slate-400 text-sm border-t border-rose-100/50 dark:border-slate-800">
          Kwiaciarnia Marek Nowak © {new Date().getFullYear()}
        </footer>
      </motion.div>
    </div>
  );
