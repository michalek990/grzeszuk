...
// IMPORT ZDJĘCIA Z FOLDERU ASSETS
...
// --- ANIMACJE INTERFEJSU (Zabezpieczone przez 'as const' przed błędami typowania) ---
const fadeInUp = {
...
export default function App() {
  ...
  useEffect(() => {
    document.title =
      "Michał Grzeszuk | Ekspert Frontend i UI/UX dla Biznesu B2B";
    ...
    updateMetaTag(
      "og:description",
      "Stabilna architektura cyfrowa i interfejsy zorientowane na zysk Twojej firmy.",
      true,
    );
  ...
  const renderView = () => {
    ...
    return (
      ...
      >
        <div className="absolute inset-0 moving-grid-bg pointer-events-none z-0" />
        ...
        <nav className="fixed top-0 w-full z-50 bg-white/70 dark:bg-slate-950/70 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50 transition-colors duration-500">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            >
              Grzeszuk
              <span className="text-indigo-600 dark:text-indigo-400">.com</span>
            </motion.div>
            ...
            <div className="hidden md:flex gap-8 font-medium">
              <a
                href="#o-mnie"
                onClick={(e) => handleScroll(e, "o-mnie")}
                className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors relative after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[2px] after:bg-indigo-600 dark:after:bg-indigo-400 hover:after:w-full after:transition-all"
              >
                O mnie
              </a>
              <a
            ...
            {isMenuOpen && (
              ...
              >
                <a
                  href="#o-mnie"
                  onClick={(e) => handleScroll(e, "o-mnie")}
                  className="py-2 px-4 hover:bg-indigo-50 dark:hover:bg-indigo-950/50 rounded-xl transition-colors"
                >
                  O mnie
                </a>
                <a
                ...
                <a
                  href="#kontakt"
                  onClick={(e) => handleScroll(e, "kontakt")}
                  className="py-2 px-4 hover:bg-indigo-50 dark:hover:bg-indigo-950/50 rounded-xl transition-colors text-indigo-600 dark:text-indigo-400"
                >
                  Kontakt
                </a>
              </motion.div>
        ...
        <section className="relative pt-40 pb-20 md:pt-52 md:pb-32 px-6 overflow-hidden z-10">
          <motion.div
            className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-indigo-100/50 dark:bg-indigo-900/20 rounded-full blur-3xl -z-10"
            animate={{ y: [0, -25, 0], scale: [1, 1.05, 1] }}
            transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
          />
          <motion.div
            className="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-sky-100/50 dark:bg-sky-900/20 rounded-full blur-3xl -z-10"
          ...
          >
            ...
            >
              Twój biznes potrzebuje czegoś więcej niż ładnej wizytówki.
              Projektuję strony, które budują zaufanie, rozwiązują problemy i
              zauważalnie zwiększają sprzedaż.
            </motion.p>
            <motion.div
              variants={fadeInUp}
            ...
            >
              <a
                href="#kontakt"
                onClick={(e) => handleScroll(e, "kontakt")}
                className="group flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-full font-medium text-lg hover:shadow-xl hover:shadow-indigo-500/20 transition-all active:scale-95"
              >
              ...
              <a
                href="#projekty"
                onClick={(e) => handleScroll(e, "projekty")}
                className="w-full sm:w-auto px-8 py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full font-medium text-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors active:scale-95 text-center shadow-sm"
              >
                Zobacz wyniki prac
              </a>
            </motion.div>
        ...
        <section
          id="o-mnie"
          className="py-24 bg-white/40 dark:bg-slate-900/40 backdrop-blur-sm z-10 relative border-y border-slate-200/30 dark:border-slate-800/30"
        >
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
              ...
              >
                <h2 className="text-4xl md:text-5xl font-bold mb-6">
                  Partnerstwo oparte na architekturze zaufania.
                </h2>
                <p className="text-lg text-slate-600 dark:text-slate-400 mb-6 leading-relaxed">
                  Wierzę, że technologia ma przede wszystkim realizować cele
                  biznesowe: eliminować opóźnienia, chronić procesy i
                  automatyzować obsługę klientów. Nie wdrażam rozwiązań tylko
                  dlatego, że są modne – dobieram je na podstawie twardych badań
                  wydajnościowych.
                </p>
        ...
        <section id="projekty" className="py-24 z-10 relative">
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                Rozwiązania poparte wynikami.
              </h2>
              <p className="text-lg text-slate-600 dark:text-slate-400">
                Zobacz systemy wdrożone z myślą o stabilności struktury i
                realnym zwrocie z inwestycji dla partnerów.
              </p>
            </motion.div>
        ...
        <section
          id="kontakt"
          className="py-24 z-10 relative bg-indigo-50/30 dark:bg-slate-900/20 backdrop-blur-sm border-t border-slate-200/40 dark:border-slate-800/40"
        >
          <div className="max-w-7xl mx-auto px-6">
            <motion.div
                ...
                <div className="w-full lg:w-2/5 bg-slate-900 dark:bg-slate-900 p-12 lg:p-16 text-white flex flex-col justify-between relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-3xl md:text-4xl font-bold mb-4">
                      Zoptymalizujmy Twój biznes.
                    </h3>
                    <p className="text-slate-400 mb-12 text-base md:text-lg leading-relaxed">
                      Opowiedz mi o wymaganiach systemowych, wyzwaniach z
                      wydajnością lub celach wizerunkowych Twojej firmy.
                      Znajdziemy rozwiązanie oparte na twardych parametrach
                      operacyjnych.
                    </p>
                    ...
                    <div className="space-y-8">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <a
                            href="mailto:michal.grzeszuk@gmail.com"
                            className="text-base md:text-lg font-medium hover:text-indigo-400 transition-colors"
                          >
                            michal.grzeszuk@gmail.com
                          </a>
                        </div>
                      </div>
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full px-5 py-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600"
                        />
                      </div>
                      <div className="space-y-2">
                        <label
                    ...
                    <div className="space-y-2">
                      <label
                        ...
                        className="text-sm font-semibold text-slate-700 dark:text-slate-300"
                      >
                        Opisz krótko swoje potrzeby systemowe i cele biznesowe
                      </label>
                      <textarea
                        id="contact-message"
                        rows={5}
                        placeholder="W czym możemy pomóc? Bezpieczna witryna wizerunkowa, zaawansowana platforma rezerwacji, audyt wydajnościowy..."
                        className="w-full px-5 py-4 rounded-[2rem] bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all resize-none placeholder:text-slate-400 dark:placeholder:text-slate-600"
                      ></textarea>
                    </div>
                    <button
                      type="submit"
                      className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full font-semibold text-base transition-all shadow-lg shadow-indigo-600/20 active:scale-[0.98] mt-4"
                    >
        ...
        <footer className="py-8 border-t border-slate-200/60 dark:border-slate-800/60 bg-white/50 dark:bg-slate-950/50 text-slate-500 dark:text-slate-400 text-center z-10 relative backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm">
              © {new Date().getFullYear()} Grzeszuk.com. Wszelkie prawa
              zastrzeżone.
            </p>
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
                aria-label="LinkedIn"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors"
                aria-label="GitHub"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              <a
                href="https://wa.me/48577980820"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-500 dark:text-slate-400 hover:text-green-500 transition-colors"
                aria-label="WhatsApp"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              {/* Discord */}
              <a
                href="https://discord.gg/TWOJ-KOD"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-500 dark:text-slate-400 hover:text-indigo-500 transition-colors"
                aria-label="Discord"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                    Ta strona wykorzystuje ciasteczka (cookies) do celów
                    statystycznych i optymalizacji działania. Korzystając ze
                    strony, zgadzasz się na ich zapis w Twojej przeglądarce.
                  </p>
                </div>
              </div>
