...
export default function App() {
  ...
  const [currentView, setCurrentView] = useState<
    "portfolio" | "mej" | "notary" | "restaurant" | "b2b"
  >("portfolio");
      ...
      >
        ...
        <nav className="fixed top-0 w-full z-50 bg-white/70 dark:bg-slate-950/70 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50 transition-colors duration-500">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            {/* UKRYTY SKRÓT: Trzymanie klawisza Alt + kliknięcie w logo przenosi do strefy B2B */}
            <div
              className="font-bold text-xl tracking-tight cursor-pointer z-50 select-none"
              onClick={(e) => {
                if (e.altKey) {
                  setCurrentView("b2b");
                } else {
              ...
              <div className="flex flex-col lg:flex-row">
                <div className="w-full lg:w-2/5 bg-slate-900 dark:bg-slate-900 p-12 lg:p-16 text-white flex flex-col justify-between relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-slate-400 mb-12 text-base md:text-lg tracking-relaxed leading-relaxed">
